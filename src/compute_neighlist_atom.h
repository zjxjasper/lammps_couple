...
ComputeStyle(neighlist/atom,ComputeNeighlistAtom)

#else

#ifndef LMP_COMPUTE_Neighlist_ATOM_H
#define LMP_COMPUTE_Neighlist_ATOM_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeNeighlistAtom : public Compute {
 public:
  ComputeNeighlistAtom(class LAMMPS *, int, char **);
  ~ComputeNeighlistAtom();
  void init();
