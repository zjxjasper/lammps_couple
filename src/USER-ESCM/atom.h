...
class Atom : protected Pointers {
 ...
 //defined by Jiaxi Zhang for coupled model
  double **fext;   //external force, IVC from f_react, SVC from f_compensate
  int *IVC_id;     //which interface_node this atom belong to
